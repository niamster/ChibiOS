...
static const uint8_t vcom_configuration_descriptor_data[67] = {
  ...
  USB_DESC_ENDPOINT     (USBD_DATA_REQUEST_EP|0x80,
  ...
  USB_DESC_ENDPOINT     (USBD_INTERRUPT_REQUEST_EP|0x80,  /* bEndpointAddress.*/
                         0x02,          /* bmAttributes (Bulk).             */
                         0x0040,        /* wMaxPacketSize.                  */
                         0x00)          /* bInterval.                       */
};
 ...
 * @brief   IN EP0 state.
 */
static USBInEndpointState ep0InState;

/**
 * @brief   OUT EP0 state.
 */
static USBOutEndpointState ep0OutState;
...
static void usb_event(USBDriver *usbp, usbevent_t event) {
  ...
  case USB_EVENT_RESET:
    usbInitEndpointI(usbp, 0, &ep0config);
    break;
